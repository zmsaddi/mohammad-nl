...
export async function updatePurchase(data) {
  await sql`UPDATE purchases SET notes = ${data.notes || ''}, updated_by = ${data.updatedBy || null}, updated_at = NOW() WHERE id = ${data.id}`;
}
...
export async function updateExpense(data) {
  await sql`UPDATE expenses SET category=${data.category}, description=${data.description}, amount=${data.amount}, notes=${data.notes || ''}, updated_by=${data.updatedBy || null}, updated_at=NOW() WHERE id=${data.id}`;
}

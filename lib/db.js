  ...
  if (driverUsername) {
    ...
    if (driverRole === 'driver') {
      ...
      const driverFixed = driverOverride?.driver_fixed != null
        ? parseFloat(driverOverride.driver_fixed)

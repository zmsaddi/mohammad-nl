...
// and only if the alias is not already present (composite uniqueness on
// entity_type + normalized_alias). Safe to call from initDatabase() repeatedly.
/**
 * Inserts hardcoded Arabic→English product aliases for the voice flow.
...
export async function seedProductAliases() {
  ...
  const KNOWN_ALIASES = [
    // V20 Mini
    { arabic: 'في عشرين ميني', english: 'V20 Mini' },
    { arabic: 'الميني',         english: 'V20 Mini' },
    { arabic: 'دراجة صغيرة',    english: 'V20 Mini' },

    // V20 Pro
    { arabic: 'في عشرين برو',  english: 'V20 Pro' },
    { arabic: 'الفيشن',         english: 'V20 Pro' },
    { arabic: 'في عشرين',       english: 'V20 Pro' },
    { arabic: 'الفي٢٠',        english: 'V20 Pro' },
    { arabic: 'البيست سيلر',    english: 'V20 Pro' },

    // V20 Limited
    { arabic: 'في عشرين ليمتد', english: 'V20 Limited' },
    { arabic: 'الليمتد',          english: 'V20 Limited' },
    { arabic: 'السادل الطويل',   english: 'V20 Limited' },

    // V20 Limited Pro
    { arabic: 'في عشرين ليمتد برو', english: 'V20 Limited Pro' },
    { arabic: 'الليمتد برو',          english: 'V20 Limited Pro' },
    { arabic: 'مية كيلو',             english: 'V20 Limited Pro' },

    // S20 Pro
    { arabic: 'إس عشرين برو', english: 'S20 Pro' },
    { arabic: 'إس عشرين',      english: 'S20 Pro' },
    { arabic: 'السينا',         english: 'S20 Pro' },

    // V20 Cross
    { arabic: 'في عشرين كروس', english: 'V20 Cross' },
    { arabic: 'الكروس',          english: 'V20 Cross' },
    { arabic: 'كروس بالسبيكر',  english: 'V20 Cross' },

    // Q30 Pliable
    { arabic: 'كيو ثلاثين',    english: 'Q30 Pliable' },
    { arabic: 'الطوي',           english: 'Q30 Pliable' },
    { arabic: 'القابلة للطي',   english: 'Q30 Pliable' },
    { arabic: 'الطايبة',         english: 'Q30 Pliable' },

    // D50
    { arabic: 'دي خمسين',        english: 'D50' },
    { arabic: 'الليدي الكبيرة',   english: 'D50' },
    { arabic: 'للبنات الكبيرة',   english: 'D50' },

    // C28
    { arabic: 'سي ثمانية وعشرين', english: 'C28' },
    { arabic: 'الليدي الصغيرة',    english: 'C28' },
    { arabic: 'للبنات الصغيرة',    english: 'C28' },

    // EB30
    { arabic: 'إي بي ثلاثين', english: 'EB30' },
    { arabic: 'الدوبل',         english: 'EB30' },
    { arabic: 'دوبل باتري',     english: 'EB30' },

    // V20 Max
    { arabic: 'في عشرين ماكس', english: 'V20 Max' },
    { arabic: 'الماكس',          english: 'V20 Max' },
    { arabic: 'للطوال',          english: 'V20 Max' },
    { arabic: 'الكبيرة 24',      english: 'V20 Max' },
  ];
...
/**
 * Public wrapper around `calculateBonusInTx` that opens its own
 * transaction. Most callers should prefer the in-tx helper so bonus
 * creation shares the same client as the sale/delivery mutation.
 * @param {number} saleId

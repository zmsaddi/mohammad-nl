...
export async function addSale(data) {
  ...
  const { rows } = await sql`
    ...
    VALUES (${data.date}, ${data.clientName}, ${data.item}, ${data.quantity}, ${costPrice}, ${sellPrice}, ${total}, ${costTotal}, ${profit}, ${data.paymentMethod}, ${data.paymentType || 'نقدي'}, ${paid}, ${remaining}, 'محجوز', ${saleRef}, ${data.createdBy || ''}, ${data.notes || ''})
    RETURNING id
  `;
...
export async function updateDelivery(data) {
  ...
  // DELIVERY CONFIRMED → Confirm sale + calculate bonuses

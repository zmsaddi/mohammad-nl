...
export const BonusRateUpdateSchema = z.object({
  ...
  seller_fixed:      nullable(z.coerce.number().min(0, 'البونص لا يمكن أن يكون سالباً').optional()),
  seller_percentage: nullable(z.coerce.number().min(0).max(100, 'النسبة بين 0 و 100').optional()),
  driver_fixed:      nullable(z.coerce.number().min(0, 'البونص لا يمكن أن يكون سالباً').optional()),
});

...
export const SaleSchema = z.object({
  ...
  notes:         z.string().optional().default(''),
  // FEAT-04: down_payment_expected. Accepts number, numeric string, or
  // empty string (falls through to addSale's reactive default based on
  // paymentType). Validated strictly in addSale against [0, total].
  downPaymentExpected: z

...
export const FEW_SHOT_EXAMPLES = [
  ...
  { role: 'assistant', content: null, tool_calls: [{ type: 'function', function: { name: 'register_sale', arguments: '{"client_name":"أحمد","item":"دراجة كهربائية","quantity":1,"unit_price":750,"payment_type":"كاش"}' } }] },

  { role: 'user', content: 'بعت لمحمد ثلاث بطاريات' },
  { role: 'assistant', content: null, tool_calls: [{ type: 'function', function: { name: 'request_clarification', arguments: '{"question":"كم سعر الوحدة؟ وهل الدفع كاش أو بنك أو آجل؟","missing_fields":["unit_price","payment_type"]}' } }] },

  { role: 'user', content: 'اشتريت من المصنع عشر بطاريات بمية وخمسين بنك' },
  { role: 'assistant', content: null, tool_calls: [{ type: 'function', function: { name: 'register_purchase', arguments: '{"supplier":"المصنع","item":"بطارية","quantity":10,"unit_price":150,"payment_type":"بنك"}' } }] },

  { role: 'user', content: 'مصروف إيجار المحل ألفين وخمسمية كاش' },
  { role: 'assistant', content: null, tool_calls: [{ type: 'function', function: { name: 'register_expense', arguments: '{"category":"إيجار","description":"إيجار المحل","amount":2500,"payment_type":"كاش"}' } }] },

  { role: 'user', content: 'سجل مصروف' },
  { role: 'assistant', content: null, tool_calls: [{ type: 'function', function: { name: 'request_clarification', arguments: '{"question":"إيش نوع المصروف؟ وكم المبلغ؟ كاش أو بنك؟","missing_fields":["category","description","amount","payment_type"]}' } }] },
];

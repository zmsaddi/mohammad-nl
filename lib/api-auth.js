...
// v1.2 S5 [F-072] — env validation activation (soft-fallback diagnostic).
// See lib/env.js for the boot-time check. Imported here so any route layer
// that hits this helper is guaranteed to have run validation at least once.
import './env.js';

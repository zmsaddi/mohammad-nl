// Shared numeric/money input convention (Commit 6 — shared primitives).
// Spread onto any amount/quantity/rate <input> so phones open the numeric
// keypad: <input {...numberInputProps} value=... />. Single source of truth —
// the <MoneyInput> component is built on this too.
export const numberInputProps = { type: 'number', inputMode: 'decimal' };

...
// v1.2 S5 [F-072] — env validation activation. The import has side effects
// (Zod schema parse + console.error on missing vars) and runs once at boot.
// Soft-fallback semantics preserved (see lib/env.js) — does NOT throw on
// missing vars, only logs a clear diagnostic line so the issue surfaces
// before the first request rather than as a 500 on the user's first action.
import '../env.js';

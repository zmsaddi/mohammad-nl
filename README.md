...
- نظام توصيل تلقائي مع VIN وفواتير PDF فرنسية (صيغة SAS قانونية)
- نظام ديون للعملاء مع تسجيل الدفعات — FIFO + تسديد على طلب محدد
- صفحة تفاصيل عميل شاملة: السجل المالي، الفواتير، تسجيل الدفعات، إلغاء الطلبات
- فلاتر وترتيب تفاعلي بنقرة عنوان العمود على جميع الصفحات الرئيسية
- إدخال صوتي بالعربية — وضع المساعد التجريبي (Whisper large-v3 + Llama 3.1 8B Instant) مع حوار مراجعة إلزامي قبل الحفظ
- نظام عمولات للبائعين والسائقين — حراس صلاحيات صارمة (seller/driver فقط)
- قاعدة إلغاء مُوثقة: admin/manager/seller/driver × محجوز/مؤكد
- داشبورد شامل مع حسابات accrual و cash-basis (P&L)

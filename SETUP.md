...
2. أنشئ **8 تبويبات** بالأسماء التالية بالضبط:
...
### تبويب: المنتجات
```
معرف | اسم المنتج | الفئة | الوحدة | السعر الافتراضي | ملاحظات
```

### تبويب: الموردين
```
معرف | اسم المورد | رقم الهاتف | العنوان | ملاحظات
```

### تبويب: التوصيل
```
معرف | التاريخ | اسم العميل | رقم الهاتف | العنوان | الأصناف | المبلغ | الحالة | اسم السائق | ملاحظات
```
